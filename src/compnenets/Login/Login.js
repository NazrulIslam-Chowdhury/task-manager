...
const Login = () => {
    return (
        <div className='flex justify-center mt-12 mx-2'>
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-600 dark:text-gray-100">
                ...
                <div className="my-6 space-y-4">
                    <button aria-label="Login with Google" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400">
                ...
                <form noValidate="" action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
                    ...
                    <button className="w-full px-8 py-3 font-semibold rounded-md dark:bg-violet-400 dark:text-gray-900">Sign in</button>
                </form>
            </div>
        </div>
    );
